...
import { TipoSostenimiento } from "../../../shared/enums/estados";
import dayjs from "dayjs";
import { Schema_CrearLabor } from "../service/labores.requests";
...
export const RegistroLaborMina = ({
  idMina,
  onSuccess,
  onCancel,
}: RegistroLaborMinaProps) => {
