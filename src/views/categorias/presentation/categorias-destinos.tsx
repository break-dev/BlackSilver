            ...
            <div className="p-4 border border-zinc-800 bg-zinc-900/40 rounded-xl">
                <Group gap="sm" align="center" mb="md">
                    ...
                    <Stack gap={0}>
                        ...
                        <Text size="xs" className="text-zinc-500 lowercase first-letter:uppercase">
                ...
                <Select
                    ...
                    data={categoriasParaConsumo.filter(c => !idsDestinosTemp.includes(Number(c.value)))}
                    searchable
                    nothingFoundMessage="No hay más categorías disponibles"
                    radius="lg"
                    classNames={{
                        input: "bg-zinc-900/50 border-zinc-800 text-white placeholder:text-zinc-600 focus:border-indigo-500 transition-all",
