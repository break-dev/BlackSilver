...
interface NuevoLoteFormProps {
  groupIndex: number;
  lotIndex: number;
  lot: DTO_RecibirEntregaReposicionItem;
  setLotValue: <K extends keyof DTO_RecibirEntregaReposicionItem>(
    groupIndex: number,
    lotIndex: number,
    field: K,
    value: DTO_RecibirEntregaReposicionItem[K],
  ) => void;
  getLotError: (
    groupIndex: number,
    lotIndex: number,
    field: keyof DTO_RecibirEntregaReposicionItem,
  ) => string | null;
