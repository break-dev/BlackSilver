...
import { LoteRowTransferencia } from "./LoteRowTransferencia";
...
export const LotesTableTransferencia = ({
  idDetalle,
  detalle,
  lotes,
  loading,
          ...
          {lotesVisibles.length === 0 ? (
            ...
            lotesVisibles.map((lote) => (
              <LoteRowTransferencia
                ...
                cantidadMaximaTransferirBase={cantidadMaximaTransferirBase}
              />
            ))
          )}
        </tbody>
