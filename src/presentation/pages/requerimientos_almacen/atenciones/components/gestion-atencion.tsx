...
export const GestionAtencion = ({
  ...
  const [selectedIdProducto, setSelectedIdProducto] = useState<number | null>(
    null,
  );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <Stack gap={4}>
            ...
            <Text size="sm" fw={800} className="text-zinc-100 italic">
              {detalle.fecha_entrega_requerida
                ? dayjs(detalle.fecha_entrega_requerida).format("DD/MM/YYYY")
                : "No especificada"}
            </Text>
          </Stack>
          ...
          <Table verticalSpacing="md" horizontalSpacing="xl">
            ...
            <tbody className="divide-y divide-zinc-800/50">
              {detalle.detalles.map((item, idx) => {
                ...
                return (
                  <tr
                    key={item.id_requerimiento_detalle}
                      ...
                      <Group gap={6} justify="center">
                        {!!item.es_fiscalizado && (
                          <Badge
                            ...
                            color="red"
                            radius="md"
                            className="font-bold px-3 py-2.5 border border-red-900/20"
                          >
                            FISCALIZADO
                          </Badge>
                        )}
                        {!!item.es_perecible && (
                          <Badge
                            ...
                            color="orange"
                            radius="md"
                            className="font-bold px-3 py-2.5 border border-orange-900/20"
                          >
                            PERECIBLE
                          </Badge>
                        )}
        ...
        <Stack gap="md">
          <div className="p-4 bg-red-500/10 border border-red-900/50 rounded-xl flex items-start gap-4">
            ...
            <Text size="sm" className="text-red-100 italic">
              Esta acción marcará el producto como rechazado y no podrá ser
              entregado.
            </Text>
          </div>
          <Textarea
            ...
            classNames={{
              input:
                "bg-zinc-900 border-zinc-800 focus:border-red-500 transition-colors text-white",
