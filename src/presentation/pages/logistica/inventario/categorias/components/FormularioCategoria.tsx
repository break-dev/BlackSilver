...
const schema = z.object({
    ...
    tipo_requerimiento: z.nativeEnum(TipoRequerimiento, { message: "Seleccione un tipo válido" }),
});
...
export const FormularioCategoria = ({
    ...
    const form = useForm({
        initialValues: {
            ...
            tipo_requerimiento: categoria?.tipo_requerimiento || "" as TipoRequerimiento,
        },
    ...
    const handleSubmit = async (values: typeof form.values) => {
        ...
        if (exito) {
            notifications.show({
                title: "Éxito",
                message: categoria ? "Categoría actualizada correctamente" : "Categoría creada correctamente",
                color: "green",
            });
            onSuccess();
        } else {
