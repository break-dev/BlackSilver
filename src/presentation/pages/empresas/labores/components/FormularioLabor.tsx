...
import { z } from "zod";
import { useLabor } from "../../../../../services/empresa/labores/useLabor";
import { EstadoBase, TipoLabor, TipoSostenimiento } from "../../../../../shared/enums";
import type { RES_Labor } from "../../../../../services/empresa/labores/dtos/labor.dto";
...
const schema = z.object({
    ...
    tipo_labor: z.nativeEnum(TipoLabor, { message: "Seleccione un tipo de labor válido" }),
    tipo_sostenimiento: z.nativeEnum(TipoSostenimiento, { message: "Seleccione un tipo de sostenimiento válido" }),
});
...
export const FormularioLabor = ({
    ...
    const form = useForm({
        initialValues: {
            ...
            tipo_sostenimiento: labor?.tipo_sostenimiento || "" as TipoSostenimiento,
        },
    ...
    const handleSubmit = async (values: typeof form.values) => {
        ...
        if (exito) {
            notifications.show({
                title: "Éxito",
                message: labor ? "Labor actualizada correctamente" : "Labor creada correctamente",
                color: "green",
            });
            onSuccess();
        } else {
    ...
    const tipoSostenimientoOptions = Object.values(TipoSostenimiento).map((val) => ({
        value: val,
        label: val,
    }));
