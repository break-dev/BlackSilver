...
export const EmpresasLabores = () => {
    ...
    const laboresFiltradas = useMemo(() => {
        return labores.filter((l) => {
            ...
            const directConcesionMatch = l.concesion?.toLowerCase().includes(filtro.toLowerCase());

            const tipoMatch = l.tipo_labor.toLowerCase().includes(filtro.toLowerCase());
        ...
        <div className="space-y-6">
                    ...
                    <Table.Tbody>
                        {laboresFiltradas.length > 0 ? (
                            laboresFiltradas.map((l, index) => {
                                ...
                                const cons = concesiones.find((c) => String(c.id_concesion) === String(l.id_concesion));
                                const nombreConcesion = cons ? cons.nombre : (l.concesion || "Desconocida");
            ...
            >
                <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white mb-2">Eliminar Labor</h3>
                        <p className="text-zinc-400 text-sm">
                            ¿Estás seguro que deseas eliminar esta labor? Esta acción no se puede deshacer.
                        </p>
                    </div>
