...
import type { RES_Asignacion } from "../../../../../services/concesiones/dtos/responses";
...
export const GestionEmpresasMina = ({
  ...
  const [empresasContrato, setEmpresasContrato] = useState<RES_Asignacion[]>(
    [],
  ); // Valid companies (by contract)
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="p-4 border border-zinc-800 bg-zinc-900/40 rounded-xl">
          ...
          <p className="text-xs text-zinc-500 mb-4">
            Solo se muestran empresas con contrato VIGENTE en la concesión de
            esta mina.
          </p>
